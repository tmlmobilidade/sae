...
//
// GRADES:
// → PASS = Trip start time delay is less than or equal to 3 minutes.
// → FAIL = Trip start time delay is greater than 3 minutes.

/* * */

interface ExtendedAnalysisResult extends AnalysisData {
	code: 'SIMPLE_DELAYED_START_THREE_MINUTES_LAST_FOR_FIRST_STOP'
	reason: 'NO_LAST_EVENT_FOR_FIRST_STOP_ID' | 'TRIP_STARTED_LESS_THAN_OR_EQUAL_TO_THREE_MINUTES_LATE' | 'TRIP_STARTED_MORE_THAN_THREE_MINUTES_LATE'
