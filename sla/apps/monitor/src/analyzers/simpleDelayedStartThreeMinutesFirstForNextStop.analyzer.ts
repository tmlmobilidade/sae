...
interface ExtendedAnalysisResult extends AnalysisData {
	code: 'SIMPLE_DELAYED_START_THREE_MINUTES_FIRST_FOR_NEXT_STOP'
	reason: 'NO_EVENT_FOUND_FOR_NEXT_STOP_ID' | 'TRIP_STARTED_LESS_THAN_OR_EQUAL_TO_THREE_MINUTES_LATE' | 'TRIP_STARTED_MORE_THAN_THREE_MINUTES_LATE'
