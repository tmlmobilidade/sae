	...
	return (
		<CardTemplate endDate={sequentialityData?.end_date} isLoading={sequentialityLoading} isValidating={sequentialityValidating} startDate={sequentialityData?.start_date} timestamp={sequentialityData?.timestamp} title={title}>
			<div className={styles.section}>
				<BigNumber label="sam_qty" level={3} value={sequentialityData?.sam_qty} />
				<BigNumber label="sam_complete_qty" level={3} type="good" value={sequentialityData?.sam_complete_qty} />
				<BigNumber label="sam_incomplete_qty" level={3} type="bad" value={sequentialityData?.sam_incomplete_qty} />
			</div>
			<div className={styles.section}>
				<BigNumber direction="column" label="transactions_expected_qty" level={1} value={sequentialityData?.transactions_expected_qty} />
				<BigNumber direction="column" label="transactions_found_qty" level={1} type="good" value={sequentialityData?.transactions_found_qty} />
				<BigNumber direction="column" label="transactions_missing_qty" level={1} type="bad" value={sequentialityData?.transactions_missing_qty} />
			</div>
