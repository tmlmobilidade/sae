...
import { type Ride, RideAnalysisAtLeastOneVehicleEventOnFirstStop, RideAnalysisAtLeastOneVehicleEventOnLastStop, RideAnalysisExpectedApexValidationInterval, RideAnalysisExpectedDriverIdQty, RideAnalysisExpectedStartTime, RideAnalysisExpectedVehicleEventDelay, RideAnalysisExpectedVehicleEventInterval, RideAnalysisExpectedVehicleEventQty, RideAnalysisExpectedVehicleIdQty, RideAnalysisMatchingApexLocations, RideAnalysisMatchingVehicleIds, RideAnalysisSimpleOneApexValidation, RideAnalysisSimpleOneVehicleEventOrApexValidation, RideAnalysisSimpleThreeVehicleEvents, RideAnalysisTransactionSequentiality, RideWithAnalyses } from '@tmlmobilidade/go-types-operation';
import { Dates } from '@tmlmobilidade/go-utils-dates';

/* * */

interface ParseRideWithAnalysesIntoRideAndAnalysesReturnType {
	ride: Ride
	rideAnalysisAtLeastOneVehicleEventOnFirstStop: RideAnalysisAtLeastOneVehicleEventOnFirstStop
	rideAnalysisAtLeastOneVehicleEventOnLastStop: RideAnalysisAtLeastOneVehicleEventOnLastStop
	rideAnalysisExpectedApexValidationInterval: RideAnalysisExpectedApexValidationInterval
	rideAnalysisExpectedDriverIdQty: RideAnalysisExpectedDriverIdQty
	rideAnalysisExpectedStartTime: RideAnalysisExpectedStartTime
	rideAnalysisExpectedVehicleEventDelay: RideAnalysisExpectedVehicleEventDelay
	rideAnalysisExpectedVehicleEventInterval: RideAnalysisExpectedVehicleEventInterval
	rideAnalysisExpectedVehicleEventQty: RideAnalysisExpectedVehicleEventQty
	rideAnalysisExpectedVehicleIdQty: RideAnalysisExpectedVehicleIdQty
	rideAnalysisMatchingApexLocations: RideAnalysisMatchingApexLocations
	rideAnalysisMatchingVehicleIds: RideAnalysisMatchingVehicleIds
	rideAnalysisSimpleOneApexValidation: RideAnalysisSimpleOneApexValidation
	rideAnalysisSimpleOneVehicleEventOrApexValidation: RideAnalysisSimpleOneVehicleEventOrApexValidation
	rideAnalysisSimpleThreeVehicleEvents: RideAnalysisSimpleThreeVehicleEvents
	rideAnalysisTransactionSequentiality: RideAnalysisTransactionSequentiality
}

export function parseRideWithAnalysesIntoRideAndAnalyses(doc: RideWithAnalyses): null | ParseRideWithAnalysesIntoRideAndAnalysesReturnType {
	//
