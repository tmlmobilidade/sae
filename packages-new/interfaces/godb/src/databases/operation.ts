...
import { type Alert, AlertSchema, type GtfsValidation, GtfsValidationSchema, type Plan, PlanSchema, type Ride, type RideAcceptance, RideAcceptanceSchema, RideSchema, type Sam, SamSchema, type Vehicle, vehicleSchema } from '@tmlmobilidade/go-types-operation';
...
export class OperationDatabase {
	...
	public readonly rides: GoDbCollection<Ride>;
	...
	public constructor(instance: MongoClient) {
		...
		this.rides = createGoDbCollection<Ride>({ collectionName: 'rides', database: this.database, indexDescription: ridesIndexes, schema: RideSchema });
	}
}
